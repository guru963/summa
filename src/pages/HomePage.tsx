...
const HOW_IT_WORKS = [
  {
    ...
    desc: 'Enter your Stableford scores after each round. Your best 5 scores shape your draw entries.',
    color: 'text-blue-400',
  ...
  },
  {
    ...
    desc: 'Every subscriber automatically enters the monthly draw. 3, 4, or 5-number matches win prizes.',
  ...
  },
  {
    ...
    desc: 'A portion of every subscription goes directly to your chosen charity — minimum 10%.',
    color: 'text-red-400',
  ...
  },
  {
    ...
    icon: Zap,
    title: 'Win & Celebrate',
    desc: 'Matched numbers? Verify your win, get paid, and share the moment. Jackpot rolls over if unclaimed.',
    color: 'text-gold-400',
...
export default function HomePage() {
  const featuredCharities = DEMO_CHARITIES.filter(c => c.is_featured).slice(0, 2)
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="font-display font-bold text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-tight leading-[0.95] mb-6 animate-fade-up">
            <span className="text-dark-50">Golf with</span>
            <br />
            <span className="gradient-text">Purpose.</span>
            <br />
            <span className="text-dark-50">Win with</span>
            <br />
          ...
          {HOW_IT_WORKS.map((item, i) => {
            ...
            return (
              <div key={i} className="relative group">
                ...
                {i < 3 && (
                  <ChevronRight size={20} className="hidden lg:block absolute top-1/2 -right-3 -translate-y-1/2 text-dark-700 z-10" />
                )}
              </div>
            )
          })}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-dark-400 text-lg mb-8 leading-relaxed">
                Every month, 5 winning numbers are drawn. Match 3, 4, or all 5 and win your share of the prize pool. Your Stableford scores are your tickets.
              </p>
            ...
            <div className="space-y-4">
              {PRIZE_TIERS.map((tier, i) => (
                <div key={i} className={`border rounded-2xl p-5 flex items-center justify-between ${tier.color} transition-all duration-200 hover:scale-[1.01]`}>
                  <div>
              ...
              <div className="card mt-4 bg-gradient-to-r from-gold-500/5 to-transparent border-gold-500/20">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-dark-400 text-sm">Current jackpot</p>
                    <p className="font-display font-bold text-2xl text-gold-400">£14,200</p>
                  </div>
                  <Trophy size={32} className="text-gold-500/40" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div key={charity.id} className="card-hover overflow-hidden group">
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className="font-display font-semibold text-lg text-dark-100 mb-2">{charity.name}</h3>
                  ...
                  {charity.upcoming_events && (
                    <div className="mt-3 flex items-center gap-2 text-xs text-gold-400">
                      <Star size={12} />
                      <span>{charity.upcoming_events}</span>
                    </div>
                  )}
                </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-900/40 via-dark-900 to-dark-950 border border-brand-500/20 p-12 sm:p-16 text-center">
          ...
          <div className="relative z-10">
            ...
            <h2 className="font-display font-bold text-4xl sm:text-5xl text-dark-50 tracking-tight mb-4">
              Ready to play with purpose?
            </h2>
            <p className="text-dark-400 text-lg mb-8 max-w-xl mx-auto">
              Join thousands of golfers who compete, win, and give back — all in one subscription.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/charities" className="btn-secondary text-lg px-10 py-4">
                Explore Charities
              </Link>
            </div>
